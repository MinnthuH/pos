                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4>
                                ...
                                <h4>Edit Employee Attendence</h4>
                                <a href="{{ route('employee#attendance') }}" class="btn btn-primary float-sm-right"> <i
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store#attendance') }}" method="post" id="myForm">
                            @csrf
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" name="date" id="date"
                                    ...
                                    placeholder="Attendance Date" value="{{ $editData['0']['date'] }}"
                                    autocomplete="off">
                            </div>
