...
@section('admin')
@section('title')
    Add Employee | Pencil POS System
@endsection
{{-- jquery link  --}}
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('stroe#employee') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="image" name="photo" class="form-control @error('photo') is-invalid
                                            @enderror">
                                            @error('photo')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
